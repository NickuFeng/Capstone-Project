...
```{r, message=FALSE}
CEU = read_csv(glue::glue("D:/Research-project/Data/Pre_Enf_CEU_correlation_table.csv"))
colnames(CEU)[1]<-'Gene'
YRI = read_csv(glue::glue("D:/Research-project/Data/Pre_Enf_YRI_correlation_table.csv"))
colnames(YRI)[1]<-'Gene'
library(knitr)
